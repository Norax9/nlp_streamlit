...
# Debug: Check TensorFlow version
st.write("TensorFlow Version:", tf.__version__)

# Debug: Check if model file exists
if not os.path.exists("best_model.h5"):
    st.error("Error: 'best_model.h5' file not found. Please ensure the model file is in the correct directory.")
else:
    st.write("Model file 'best_model.h5' found.")
